 ...
 */
#ifndef PF_APPLICATION_NET_PACKET_LOGIN_TOGATEWAY_ASKAUTH_H_
#define PF_APPLICATION_NET_PACKET_LOGIN_TOGATEWAY_ASKAUTH_H_

#include "pf/application/net/packet/login_togateway/config.h"
...
#endif //PF_APPLICATION_NET_PACKET_LOGIN_TOGATEWAY_ASKAUTH_H_
