 ...
 */
#ifndef PF_APPLICATION_NET_PACKET_GATEWAY_TOLOGIN_RESULTAUTH_H_
#define PF_APPLICATION_NET_PACKET_GATEWAY_TOLOGIN_RESULTAUTH_H_

#include "pf/application/net/packet/gateway_tologin/config.h"
...
#endif //PF_APPLICATION_NET_PACKET_GATEWAY_TOLOGIN_RESULTAUTH_H_
