 ...
 * @uses application file defines
 */
#ifndef PF_APPLICATION_DEFINE_FILE_H_
#define PF_APPLICATION_DEFINE_FILE_H_
...
#define SCENE_INFO_FILE "./config/scene_info.ini"
#define BASE_VALUE_FILE "./config/base_value.ini"
#define ITEM_SERIAL_FILE "./config/item_serial.ini"

#endif //PF_APPLICATION_DEFINE_FILE_H_
