 ...
 */
#ifndef COMMON_NET_PACKET_LOGIN_TOGATEWAY_PLAYERLEAVE_H_
#define COMMON_NET_PACKET_LOGIN_TOGATEWAY_PLAYERLEAVE_H_
...
class PlayerLeave : public pf_net::packet::Base {
...
class PlayerLeaveFactory : public pf_net::packet::Factory {
...
class PlayerLeaveHandler {
 ...
 public:
   static uint32_t execute(PlayerLeave *packet, 
