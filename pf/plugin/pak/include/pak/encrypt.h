...
#define HEADER_BUFFER_SIZE 0x500
...
uint64_t detect_fileseed(uint64_t *block, uint64_t decrypted);
...
extern bool buffer_created;
extern uint64_t buffer[HEADER_BUFFER_SIZE];
