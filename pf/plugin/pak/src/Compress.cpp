...
namespace KPM
{
  ...
  {
    {KPM_COMPRESSION_WAVE_MONO,   Compress_wave_mono},   // IMA ADPCM mono compression
    {KPM_COMPRESSION_WAVE_STEREO, Compress_wave_stereo}, // IMA ADPCM stereo compression
    {KPM_COMPRESSION_HUFFMANN,    Compress_huff},        // Huffmann compression
    {KPM_COMPRESSION_ZLIB,        Compress_zlib},        // Compression with the "zlib" library
    {KPM_COMPRESSION_PKWARE,      Compress_pklib},       // Compression with Pkware DCL
    {KPM_COMPRESSION_BZIP2,       Compress_bzip2}        // Compression Bzip2 library
  };

  int  SCompCompress(char * pbCompressed, int * pdwOutLength, char * pbUncompressed, int dwInLength,
  ...
  {
    {KPM_COMPRESSION_BZIP2,       Decompress_bzip2},       // Decompression with Bzip2 library
    {KPM_COMPRESSION_PKWARE,      Decompress_pklib},       // Decompression with Pkware Data Compression Library
    {KPM_COMPRESSION_ZLIB,        Decompress_zlib},        // Decompression with the "zlib" library
    {KPM_COMPRESSION_HUFFMANN,    Decompress_huff},        // Huffmann decompression
    {KPM_COMPRESSION_WAVE_STEREO, Decompress_wave_stereo}, // IMA ADPCM stereo decompression
    {KPM_COMPRESSION_WAVE_MONO,   Decompress_wave_mono}    // IMA ADPCM mono decompression
  };
