...
namespace KPM
{
	...
	*/
	...
	TKPMArchive*		KPM_OpenArchive(const char* szFilename,DWORD& oresult,bool WriteFlag=true);
	...
	BOOL				KPM_AddFileFromMemory(TKPMArchive* hArchive, const char * szAliasFileName,const char* lpszFile, DWORD dwFileSize,
									DWORD dwFlags,DWORD dwQuality, DWORD nFileType); 
