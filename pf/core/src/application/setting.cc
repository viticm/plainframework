...
#include "pf/application//define/file.h"
#include "pf/net/connection/config.h"
#include "pf/application/setting.h"

pf_application::Setting *g_application_setting;

template <>
pf_application::Setting 
  *pf_base::Singleton<pf_application::Setting>::singleton_ = NULL;
