 ...
 */
#ifndef PF_APPLICATION_SETTING_H_
#define PF_APPLICATION_SETTING_H_

#include "pf/application/config.h"
...
extern pf_application::Setting *g_application_setting; //global variable

#define APPLICATION_SETTING_POINTER \
  pf_application::Setting::getsingleton_pointer()

#endif //PF_APPLICATION_SETTING_H_
